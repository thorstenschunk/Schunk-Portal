...
export async function PATCH(req:NextRequest){
  try{
    ...
    const values={start_time:start,end_time:end,pause_minutes:pause,travel_setup_minutes:travel,total_minutes:total,activity:b.activity??old.activity,notes:b.notes??old.notes,construction_site_id:b.construction_site_id??old.construction_site_id,work_date:b.work_date??old.work_date,locked:true,updated_at:new Date().toISOString()};
